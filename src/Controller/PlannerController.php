...
public function generer(
    ...
    $preferences = [
        ...
        'theme'        => (string) $request->request->get('theme', 'Découverte'),
        'hebergement'  => (string) $request->request->get('hebergement', 'Hôtel'),
        'rythme'       => (string) $request->request->get('rythme', 'Modéré'),
